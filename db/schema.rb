...
ActiveRecord::Schema.define(version: 2021_11_27_092957) do
  ...
  create_table "responses", force: :cascade do |t|
    ...
    t.datetime "updated_at", precision: 6, null: false
    t.text "content"
    t.index ["room_id"], name: "index_responses_on_room_id"
  ...
  add_foreign_key "responses", "rooms"
